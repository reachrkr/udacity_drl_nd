...
* A list of all the packages needed to set up the environment
  * python folder
  
* A Report.md file explaining the step-by-step process and the learning algorithm. It also includes some suggestions for improving the results.

* README.md File

## Results

Below are the final results of the environment.

Detailed results are found in [**Report.md**](Report.md).

#### Version 2: 20 agents
![training_results](./img/result.png)

## Acknowledgement
Coding sections taken from the DDPG lesson in the Reinforcement Learning Nano-Degree at Udacity.